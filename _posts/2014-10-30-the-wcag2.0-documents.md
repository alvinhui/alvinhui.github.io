...
[ARIA](http://www.w3.org/WAI/intro/aria.php)定义了一套属性，属性分为role以及对应的states和properties。 ARIA将html元素分为六种role，每种有对应的states和properties。web开发者和无障碍工具厂商共同遵循规范，开发在应用中使用这些属性，无障碍工具厂商读取这些属性，在即可达到应用交互的可访问性。
